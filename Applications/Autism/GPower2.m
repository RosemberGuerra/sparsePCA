function varargout=GPower2(varargin)
% Generalized power method for sparse principal component analysis.
% With PCA as initial point.
...
penalty=varargin{4};
block=varargin{5};
V = varargin{6}; % Initial PCA values
if block==1
    if nargin>5
    ...
    switch penalty
       case 'l1'        
            for comp=1:m % loop on the components
                ...
                x=V(:,comp); % initialization in PCA (Remove after using and a uncomment prevous line!!!)
