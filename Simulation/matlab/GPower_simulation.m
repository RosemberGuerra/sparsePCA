%% Simulation GPower parfor%%
% Rosember Guerra %
% Initial version: 28-06-2019 
% Edited version: 26-02-2020
...
% simulation %
% 1 means the model matches the data set     %
...
parfor i=1:Ndatasets
    ...
    % Component Weights %
    W1 = GP(Out1.Xnew,Out1.R,Out1.propsparse,1); % Component weights 
    W2 = GP(Out2.Xnew2,Out2.R,Out2.propsparse,1); % Component weights 
    W3 = GP(Out3.Xnew,Out3.R,Out3.propsparse,1); % Component weights 
    % Component scores %
    T1 = Out1.Xnew*W1; 
    T2 = Out2.Xnew2*W2;
    T3 = Out3.Xnew*W3;
...
Methodology = repmat('GPower',Ndatasets, 1);
...
DataGPower = [table(Methodology,p_sparse2) Table Table2];
writetable(DataGPower,'JointDataGPower.txt','Delimiter',',') 
save('ResultsGPower.mat')
